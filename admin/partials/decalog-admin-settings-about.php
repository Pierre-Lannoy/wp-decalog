...
$brands     = array( 'Automattic', 'Bugsnag', 'Datadog', 'Elastic Cloud', 'Fluentd Project', 'Functional Software', 'Grafana Labs', 'Google', 'InfluxData', 'New relic', 'Open Zipkin', 'Pushover', 'Rapid7', 'Raygun', 'Sematext', 'Slack', 'Solarwinds', 'Sumo Logic', 'The Linux Foundation', 'Uber' );
