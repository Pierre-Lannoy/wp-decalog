...
final class Utils
{
    ...
    public static function debugResource($value = null)
    {
        ...
        return \DLGuzzleHttp\Psr7\Utils::tryFopen('php://output', 'w');
    }
    ...
    public static function chooseHandler(): callable
    {
        ...
        if (\ini_get('allow_url_fopen')) {
            ...
            throw new \RuntimeException('DLGuzzleHttp requires cURL, the allow_url_fopen ini setting, or a custom HTTP handler.');
        }
    ...
    {
        return sprintf('DLGuzzleHttp/%d', ClientInterface::MAJOR_VERSION);
    }
     ...
     *
     * @deprecated Utils::defaultCaBundle will be removed in DLGuzzleHttp/guzzle:8.0. This method is not needed in PHP 5.6+.
     */
