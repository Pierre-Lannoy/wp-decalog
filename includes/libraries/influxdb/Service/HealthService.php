...
class HealthService
{
     ...
     */
    public function getHealthAsync($zap_trace_span = null)
    {
        return $this->getHealthAsyncWithHttpInfo($zap_trace_span)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \DLGuzzleHttp\Promise\PromiseInterface
     */
    public function getHealthAsyncWithHttpInfo($zap_trace_span = null)
    {
        $returnType = '\InfluxDB2\Model\HealthCheck';
        $request = $this->getHealthRequest($zap_trace_span);
