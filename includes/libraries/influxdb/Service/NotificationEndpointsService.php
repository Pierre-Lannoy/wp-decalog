...
class NotificationEndpointsService
{
     ...
     *
     * @param  \InfluxDB2\Model\PostNotificationEndpoint $post_notification_endpoint Notification endpoint to create (required)
     *
     * @throws \InfluxDB2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \InfluxDB2\Model\NotificationEndpoint|\InfluxDB2\Model\Error
     */
    public function createNotificationEndpoint($post_notification_endpoint)
    {
        list($response) = $this->createNotificationEndpointWithHttpInfo($post_notification_endpoint);
        return $response;
    }
     ...
     */
    public function createNotificationEndpointWithHttpInfo($post_notification_endpoint)
    {
     ...
     */
    public function createNotificationEndpointAsync($post_notification_endpoint)
    {
        return $this->createNotificationEndpointAsyncWithHttpInfo($post_notification_endpoint)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function createNotificationEndpointRequest($post_notification_endpoint)
    {
        // verify the required parameter 'post_notification_endpoint' is set
        if ($post_notification_endpoint === null || (is_array($post_notification_endpoint) && count($post_notification_endpoint) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $post_notification_endpoint when calling createNotificationEndpoint'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($post_notification_endpoint)) {
            $_tempBody = $post_notification_endpoint;
        }
