...
class TasksService
{
     ...
     * @return \InfluxDB2\Model\Run|\InfluxDB2\Model\Error
     */
    public function postTasksIDRunsIDRetry($task_id, $run_id, $zap_trace_span = null)
    {
        list($response) = $this->postTasksIDRunsIDRetryWithHttpInfo($task_id, $run_id, $zap_trace_span);
        return $response;
    }
     ...
     * @return array of \InfluxDB2\Model\Run|\InfluxDB2\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function postTasksIDRunsIDRetryWithHttpInfo($task_id, $run_id, $zap_trace_span = null)
    {
        $request = $this->postTasksIDRunsIDRetryRequest($task_id, $run_id, $zap_trace_span);
     ...
     * @return \DLGuzzleHttp\Promise\PromiseInterface
     */
    public function postTasksIDRunsIDRetryAsync($task_id, $run_id, $zap_trace_span = null)
    {
        return $this->postTasksIDRunsIDRetryAsyncWithHttpInfo($task_id, $run_id, $zap_trace_span)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \DLGuzzleHttp\Promise\PromiseInterface
     */
    public function postTasksIDRunsIDRetryAsyncWithHttpInfo($task_id, $run_id, $zap_trace_span = null)
    {
        $returnType = '\InfluxDB2\Model\Run';
        $request = $this->postTasksIDRunsIDRetryRequest($task_id, $run_id, $zap_trace_span);
     ...
     * @return \DLGuzzleHttp\Psr7\Request
     */
    protected function postTasksIDRunsIDRetryRequest($task_id, $run_id, $zap_trace_span = null)
    {
        // verify the required parameter 'task_id' is set
        if ($task_id === null || (is_array($task_id) && count($task_id) === 0)) {
            throw new \InvalidArgumentException(
