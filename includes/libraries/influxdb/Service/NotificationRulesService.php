...
class NotificationRulesService
{
     ...
     *
     * @param  \InfluxDB2\Model\PostNotificationRule $post_notification_rule Notification rule to create (required)
     *
     * @throws \InfluxDB2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \InfluxDB2\Model\NotificationRule|\InfluxDB2\Model\Error
     */
    public function createNotificationRule($post_notification_rule)
    {
        list($response) = $this->createNotificationRuleWithHttpInfo($post_notification_rule);
        return $response;
    }
     ...
     */
    public function createNotificationRuleWithHttpInfo($post_notification_rule)
    {
        $request = $this->createNotificationRuleRequest($post_notification_rule);
     ...
     */
    public function createNotificationRuleAsync($post_notification_rule)
    {
        return $this->createNotificationRuleAsyncWithHttpInfo($post_notification_rule)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \DLGuzzleHttp\Promise\PromiseInterface
     */
    public function createNotificationRuleAsyncWithHttpInfo($post_notification_rule)
    {
        $returnType = '\InfluxDB2\Model\NotificationRule';
        $request = $this->createNotificationRuleRequest($post_notification_rule);
     ...
     */
    protected function createNotificationRuleRequest($post_notification_rule)
    {
        // verify the required parameter 'post_notification_rule' is set
        if ($post_notification_rule === null || (is_array($post_notification_rule) && count($post_notification_rule) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $post_notification_rule when calling createNotificationRule'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($post_notification_rule)) {
            $_tempBody = $post_notification_rule;
        }
