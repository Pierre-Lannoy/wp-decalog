...
class DashboardsService
{
     ...
     *
     * @param  string $zap_trace_span OpenTracing span context (optional)
     * @param  string $owner The owner ID. (optional)
     * @param  string $sort_by The column to sort by. (optional)
     * @param  string[] $id List of dashboard IDs to return. If both &#x60;id and &#x60;owner&#x60; are specified, only &#x60;id&#x60; is used. (optional)
     ...
     */
    public function getDashboards($zap_trace_span = null, $owner = null, $sort_by = null, $id = null, $org_id = null, $org = null)
    {
        list($response) = $this->getDashboardsWithHttpInfo($zap_trace_span, $owner, $sort_by, $id, $org_id, $org);
        return $response;
    }
     ...
     */
    public function getDashboardsWithHttpInfo($zap_trace_span = null, $owner = null, $sort_by = null, $id = null, $org_id = null, $org = null)
    {
        $request = $this->getDashboardsRequest($zap_trace_span, $owner, $sort_by, $id, $org_id, $org);
    ...
    {
        return $this->getDashboardsAsyncWithHttpInfo($zap_trace_span, $owner, $sort_by, $id, $org_id, $org)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     *
     * @param  string $dashboard_id The ID of the dashboard to update. (required)
     * @param  \InfluxDB2\Model\Dashboard $dashboard Patching of a dashboard (required)
     * @param  string $zap_trace_span OpenTracing span context (optional)
     *
     * @throws \InfluxDB2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \InfluxDB2\Model\Dashboard|\InfluxDB2\Model\Error|\InfluxDB2\Model\Error
     */
    public function patchDashboardsID($dashboard_id, $dashboard, $zap_trace_span = null)
    {
        list($response) = $this->patchDashboardsIDWithHttpInfo($dashboard_id, $dashboard, $zap_trace_span);
        return $response;
    }
     ...
     * @return array of \InfluxDB2\Model\Dashboard|\InfluxDB2\Model\Error|\InfluxDB2\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchDashboardsIDWithHttpInfo($dashboard_id, $dashboard, $zap_trace_span = null)
    {
        $request = $this->patchDashboardsIDRequest($dashboard_id, $dashboard, $zap_trace_span);
    ...
    {
        return $this->patchDashboardsIDAsyncWithHttpInfo($dashboard_id, $dashboard, $zap_trace_span)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function patchDashboardsIDRequest($dashboard_id, $dashboard, $zap_trace_span = null)
    {
        ...
        if ($dashboard === null || (is_array($dashboard) && count($dashboard) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $dashboard when calling patchDashboardsID'
            );
        }
