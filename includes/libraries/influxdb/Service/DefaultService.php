...
class DefaultService
{
     ...
     * @return void
     */
    public function deletePost($delete_predicate_request, $zap_trace_span = null, $org = null, $bucket = null, $org_id = null, $bucket_id = null)
    {
        $this->deletePostWithHttpInfo($delete_predicate_request, $zap_trace_span, $org, $bucket, $org_id, $bucket_id);
    }
     ...
     */
    public function deletePostWithHttpInfo($delete_predicate_request, $zap_trace_span = null, $org = null, $bucket = null, $org_id = null, $bucket_id = null)
    {
        $request = $this->deletePostRequest($delete_predicate_request, $zap_trace_span, $org, $bucket, $org_id, $bucket_id);
     ...
     */
    public function deletePostAsync($delete_predicate_request, $zap_trace_span = null, $org = null, $bucket = null, $org_id = null, $bucket_id = null)
    {
        return $this->deletePostAsyncWithHttpInfo($delete_predicate_request, $zap_trace_span, $org, $bucket, $org_id, $bucket_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \DLGuzzleHttp\Promise\PromiseInterface
     */
    public function deletePostAsyncWithHttpInfo($delete_predicate_request, $zap_trace_span = null, $org = null, $bucket = null, $org_id = null, $bucket_id = null)
    {
        $returnType = '';
        $request = $this->deletePostRequest($delete_predicate_request, $zap_trace_span, $org, $bucket, $org_id, $bucket_id);
     ...
     */
    protected function deletePostRequest($delete_predicate_request, $zap_trace_span = null, $org = null, $bucket = null, $org_id = null, $bucket_id = null)
    {
        ...
        if ($delete_predicate_request === null || (is_array($delete_predicate_request) && count($delete_predicate_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $delete_predicate_request when calling deletePost'
            );
        }
     ...
     * @return void
     */
    public function postSignin($zap_trace_span = null)
    {
        $this->postSigninWithHttpInfo($zap_trace_span);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postSigninWithHttpInfo($zap_trace_span = null)
    {
        $request = $this->postSigninRequest($zap_trace_span);
     ...
     * @return \DLGuzzleHttp\Promise\PromiseInterface
     */
    public function postSigninAsync($zap_trace_span = null)
    {
        return $this->postSigninAsyncWithHttpInfo($zap_trace_span)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \DLGuzzleHttp\Promise\PromiseInterface
     */
    public function postSigninAsyncWithHttpInfo($zap_trace_span = null)
    {
        $returnType = '';
        $request = $this->postSigninRequest($zap_trace_span);
     ...
     * @return \DLGuzzleHttp\Psr7\Request
     */
    protected function postSigninRequest($zap_trace_span = null)
    {
