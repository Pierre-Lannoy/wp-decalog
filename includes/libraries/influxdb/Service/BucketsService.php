...
class BucketsService
{
     ...
     */
    public function getBuckets($zap_trace_span = null, $offset = null, $limit = 20, $after = null, $org = null, $org_id = null, $name = null)
    {
        list($response) = $this->getBucketsWithHttpInfo($zap_trace_span, $offset, $limit, $after, $org, $org_id, $name);
        return $response;
    }
     ...
     */
    public function getBucketsWithHttpInfo($zap_trace_span = null, $offset = null, $limit = 20, $after = null, $org = null, $org_id = null, $name = null)
    {
        $request = $this->getBucketsRequest($zap_trace_span, $offset, $limit, $after, $org, $org_id, $name);
     ...
     * @return \DLGuzzleHttp\Promise\PromiseInterface
     */
    public function getBucketsAsync($zap_trace_span = null, $offset = null, $limit = 20, $after = null, $org = null, $org_id = null, $name = null)
    {
        return $this->getBucketsAsyncWithHttpInfo($zap_trace_span, $offset, $limit, $after, $org, $org_id, $name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \DLGuzzleHttp\Promise\PromiseInterface
     */
    public function getBucketsAsyncWithHttpInfo($zap_trace_span = null, $offset = null, $limit = 20, $after = null, $org = null, $org_id = null, $name = null)
    {
        $returnType = '\InfluxDB2\Model\Buckets';
        $request = $this->getBucketsRequest($zap_trace_span, $offset, $limit, $after, $org, $org_id, $name);
     ...
     * @return \DLGuzzleHttp\Psr7\Request
     */
    protected function getBucketsRequest($zap_trace_span = null, $offset = null, $limit = 20, $after = null, $org = null, $org_id = null, $name = null)
    {
     ...
     *
     * @param  string $bucket_id The bucket ID. (required)
     * @param  \InfluxDB2\Model\Bucket $bucket Bucket update to apply (required)
     * @param  string $zap_trace_span OpenTracing span context (optional)
     *
     * @throws \InfluxDB2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \InfluxDB2\Model\Bucket|\InfluxDB2\Model\Error
     */
    public function patchBucketsID($bucket_id, $bucket, $zap_trace_span = null)
    {
        list($response) = $this->patchBucketsIDWithHttpInfo($bucket_id, $bucket, $zap_trace_span);
        return $response;
    }
     ...
     * @return array of \InfluxDB2\Model\Bucket|\InfluxDB2\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchBucketsIDWithHttpInfo($bucket_id, $bucket, $zap_trace_span = null)
    {
        $request = $this->patchBucketsIDRequest($bucket_id, $bucket, $zap_trace_span);
     ...
     * @return \DLGuzzleHttp\Promise\PromiseInterface
     */
    public function patchBucketsIDAsync($bucket_id, $bucket, $zap_trace_span = null)
    {
        return $this->patchBucketsIDAsyncWithHttpInfo($bucket_id, $bucket, $zap_trace_span)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \DLGuzzleHttp\Promise\PromiseInterface
     */
    public function patchBucketsIDAsyncWithHttpInfo($bucket_id, $bucket, $zap_trace_span = null)
    {
        $returnType = '\InfluxDB2\Model\Bucket';
        $request = $this->patchBucketsIDRequest($bucket_id, $bucket, $zap_trace_span);
     ...
     * @return \DLGuzzleHttp\Psr7\Request
     */
    protected function patchBucketsIDRequest($bucket_id, $bucket, $zap_trace_span = null)
    {
        // verify the required parameter 'bucket_id' is set
        if ($bucket_id === null || (is_array($bucket_id) && count($bucket_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($bucket === null || (is_array($bucket) && count($bucket) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $bucket when calling patchBucketsID'
            );
        }
