...
class ReadyService
{
     ...
     * @return \InfluxDB2\Model\Ready|\InfluxDB2\Model\Error
     */
     ...
     * @throws \InfluxDB2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \InfluxDB2\Model\Ready|\InfluxDB2\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReadyWithHttpInfo($zap_trace_span = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\InfluxDB2\Model\Ready' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\InfluxDB2\Model\Ready', []),
     ...
     */
    public function getReadyAsync($zap_trace_span = null)
    {
        return $this->getReadyAsyncWithHttpInfo($zap_trace_span)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getReadyAsyncWithHttpInfo
     *
     * Get the readiness of an instance at startup
     *
     * @param  string $zap_trace_span OpenTracing span context (optional)
     ...
     * @return \DLGuzzleHttp\Promise\PromiseInterface
     */
    public function getReadyAsyncWithHttpInfo($zap_trace_span = null)
    {
        $returnType = '\InfluxDB2\Model\Ready';
        $request = $this->getReadyRequest($zap_trace_span);
