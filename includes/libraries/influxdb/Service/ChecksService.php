...
class ChecksService
{
     ...
     * Add new check
     *
     * @param  \InfluxDB2\Model\PostCheck $post_check Check to create (required)
     *
     * @throws \InfluxDB2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \InfluxDB2\Model\Check|\InfluxDB2\Model\Error
     */
    public function createCheck($post_check)
    {
        list($response) = $this->createCheckWithHttpInfo($post_check);
        return $response;
    }
     ...
     */
    public function createCheckWithHttpInfo($post_check)
    {
        $request = $this->createCheckRequest($post_check);
     ...
     */
    public function createCheckAsync($post_check)
    {
        return $this->createCheckAsyncWithHttpInfo($post_check)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \DLGuzzleHttp\Promise\PromiseInterface
     */
    public function createCheckAsyncWithHttpInfo($post_check)
    {
        $returnType = '\InfluxDB2\Model\Check';
        $request = $this->createCheckRequest($post_check);
     ...
     */
    protected function createCheckRequest($post_check)
    {
        // verify the required parameter 'post_check' is set
        if ($post_check === null || (is_array($post_check) && count($post_check) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $post_check when calling createCheck'
            );
        }
