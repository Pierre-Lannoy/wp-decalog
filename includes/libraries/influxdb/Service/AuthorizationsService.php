...
class AuthorizationsService
{
     ...
     *
     * @param  \InfluxDB2\Model\Authorization $authorization Authorization to create (required)
     * @param  string $zap_trace_span OpenTracing span context (optional)
     *
     * @throws \InfluxDB2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function postAuthorizations($authorization, $zap_trace_span = null)
    {
        list($response) = $this->postAuthorizationsWithHttpInfo($authorization, $zap_trace_span);
        return $response;
    }
     ...
     */
    public function postAuthorizationsWithHttpInfo($authorization, $zap_trace_span = null)
    {
        $request = $this->postAuthorizationsRequest($authorization, $zap_trace_span);
     ...
     * @return \DLGuzzleHttp\Promise\PromiseInterface
     */
    public function postAuthorizationsAsync($authorization, $zap_trace_span = null)
    {
        return $this->postAuthorizationsAsyncWithHttpInfo($authorization, $zap_trace_span)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \DLGuzzleHttp\Promise\PromiseInterface
     */
    public function postAuthorizationsAsyncWithHttpInfo($authorization, $zap_trace_span = null)
    {
        $returnType = '\InfluxDB2\Model\Authorization';
        $request = $this->postAuthorizationsRequest($authorization, $zap_trace_span);
     ...
     * @return \DLGuzzleHttp\Psr7\Request
     */
    protected function postAuthorizationsRequest($authorization, $zap_trace_span = null)
    {
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling postAuthorizations'
            );
        }
