...
namespace DLMonolog\Attribute;

/**
 * A reusable attribute to help configure a class or a method as a processor.
 * 
 * Using it offers no guarantee: it needs to be leveraged by a DLMonolog third-party consumer.
 * 
 * Using it with the DLMonolog library only has no effect at all: processors should still be turned into a callable if
 * needed and manually pushed to the loggers and to the processable handlers.
 */
#[\Attribute(\Attribute::TARGET_CLASS | \Attribute::TARGET_METHOD | \Attribute::IS_REPEATABLE)]
class AsDLMonologProcessor
{
    /** @var string|null */
    public $channel = null;
    /** @var string|null */
