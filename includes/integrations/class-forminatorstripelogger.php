<?php
/**
 * Forminator Stripe integration definition.
 *
...
if ( interface_exists( '\Forminator\Stripe\Util\LoggerInterface' ) ) {
	/**
	 * Forminator Stripe integration class.
	 *
	 * This class defines all code necessary to log events with Forminator Stripe.
	 *
	 * @package API
	 * @author  Pierre Lannoy <https://pierre.lannoy.fr/>.
	 * @since 2.4.0
	 */
	class ForminatorStripeLogger implements \Forminator\Stripe\Util\LoggerInterface {
