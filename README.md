...
If you don't want to use external services, __DecaLog__ provides the tools to leverage all the benefits of observability right in the admin dashboard. It supports multisite logs delegation and contains many features to help to protect personal information (user pseudonymization, IP obfuscation, etc.).
